...
#PATH_SAVE_LOG = '/home/sithichai_t/real_project/weblog/Input/%s'

#PATH_SAVE_LOG4 = '/home/moojokeubuntu/KU/4_2/RealProject/webpattern/Output_group'
PATH_SAVE_LOG4 = '/home/moojokeubuntu/KU/4_2/RealProject/webpattern/Output_same_length/12_new'
    ...
    for j in range(2,50):
        ...
        with open (PATH_SAVE_LOG%('input_user_cut_9to12.txt'),'r') as file:
            for i in file:
                ...
                if len(web_access) == wanted_length :
